...
class UpdateTenantUserRequest extends FormRequest
{
    ...
    {
        $tenantUserId = (string) $this->route('tenantUser');
        ...
        return [
            ...
            'email' => [
                ...
                'email',
                'max:255',
                Rule::unique('tenant.users', 'email')->ignore($tenantUserId),
            ],
            'password' => ['nullable', 'string', 'confirmed', 'max:255', Password::defaults()],
